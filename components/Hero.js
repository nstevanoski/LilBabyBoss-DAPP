...
const Hero = () => {
  ...
  return (
    <main id="main" className="h-screen py-16 bg-lilbabyboss">
          ...
          {isSaleActive ? (
            <>
              ...
              <div className="flex items-center mt-6 text-3xl font-bold text-gray-200">
                <button className="btn-gold" onClick={decrementCount}>
                  <svg
                ...
                <button className="btn-gold" onClick={incrementCount}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-6 h-6 text-pink-400"
                    fill="none"
              ...
              {/* Mint Button */}
              <button
                className="btn-gold mt-3 uppercase"
