...
const Header = () => {
  ...
  return (
    <>
      ...
      <header className="sticky inset-x-0 top-0 z-10 h-20 min-w-full text-white border-purple-900 bg-lilbabyboss backdrop-filter backdrop-blur-lg bg-opacity-30">
